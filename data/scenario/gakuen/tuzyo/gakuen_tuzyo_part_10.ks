...
[glink  color="blue"  size="28"  x="360"  width="500"  y="150"  text="妥協案を出す"  exp="f.tsukuri+=10" target="*gakuen_tuzyo_part_10_1" ]
[glink  color="blue"  size="28"  x="360"  width="500"  y="250"  text="自分の案はどう？"  exp="f.tsukuri+=10" target="*gakuen_tuzyo_part_10_2" ]
[s]
