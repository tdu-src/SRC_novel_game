...
[chara_mod name="yamato" face="sad" time="1000"  ]

#yamato
うちに来たけど[l]
やることなんて特にないよ[p]

[chara_mod name="yamato" face="normal" time="1000"  ]

#akane
うーんゲームする？[p][l]
それとも映画見る[p]

[glink  color="blue"  size="28"  x="360"  width="500"  y="150"  text="映画"  target="*movie"]
[glink  color="blue"  size="28"  x="360"  width="500"  y="250"  text="ゲーム"  target="*game"]
[s]
...
#akane
うん最近愛の不時着見たから気分的には恋愛映画みたいなぁ[p]


[glink  color="blue"  size="28"  x="360"  width="500"  y="150"  text="恋愛映画"  target="*movie_love"]
[glink  color="blue"  size="28"  x="360"  width="500"  y="250"  text="アクション映画"  target="*movie_action"]
[s]
...
;-----------------------------------------------------------------------------------------------------------------
*game
[chara_mod name="akane" face="sad" time="1000" ]
#akane
うーーーーーん難しい[p]
...
[if exp="tf.random>=50" ]
[jump storage="gakuenn_2_tuuzyou.ks" ]

[elsif exp="tf.random<=50" ]
[jump storage="gakuenn_2_tokusyu.ks" ]
