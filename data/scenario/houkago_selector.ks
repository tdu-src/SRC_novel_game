...
[glink  color="&f.random_button_list[0]"  size="21"  x="50"  width="100"  y="600"  text="カフェ" target="*houkago_selector_1" exp="f.selection_button=0"]
[glink  color="&f.random_button_list[1]"  size="21"  x="250"  width="100"  y="600"  text="図書館" target="*houkago_selector_1"exp="f.selection_button=1" ]
[glink  color="&f.random_button_list[2]"  size="21"  x="450"  width="100"  y="600"  text="自宅" target="*houkago_selector_1"exp="f.selection_button=2" ]
[glink  color="&f.random_button_list[3]"  size="21"  x="650"  width="100"  y="600"  text="ゲーセン" target="*houkago_selector_1"exp="f.selection_button=3" ]
...
f.houkago_select_path+=f.random_place_list[f.selection_button];
