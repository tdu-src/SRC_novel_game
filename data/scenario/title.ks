...
[button name="credit_button" x=305 y=600 graphic="../fgimage/items/titles/gamecredit.png" enterimg="../fgimage/items/titles/gamecreditaffter.png" role="sleepgame" storage="config.ks" keyfocus="5"]
[s]
