...
tf.config_x	 		      = [1072, 300, 372, 444, 516, 588, 660, 732, 804, 876, 948];
tf.config_y 		      = [184, 260, 336, 412];
tf.img_width 		      = 56;
tf.img_height 	      = 56;
tf.config_num_bgm;
tf.config_num_se;
...
[button fix="true" graphic="&tf.img_path + 'back.png'" enterimg="&tf.img_path + 'back2.png'" target="*backtitle" x="1132" y="20"]
...
; BGMミュート
[button name="bgmvol,bgmvol_0"   fix="true" target="*vol_bgm_mute" graphic="&tf.btn_path_off" enterimg="&tf.img_path + 'mute_hover.png'" width="56" height="56" x="&tf.config_x[0]" y="184"]
...
; SEミュート
[button name="sevol,sevol_0"   fix="true" target="*vol_se_mute" graphic="&tf.btn_path_off" enterimg="&tf.img_path + 'mute_hover.png'" width="56" height="56" x="&tf.config_x[0]" y="260"]
...
;-------------------------------------------------------------------------------
; 未読スキップ-OFF
[button name="unread_off" fix="true" target="*skip_off" graphic="&tf.btn_path_off" enterimg="&tf.btn_path_on_h" width="56" height="56" x="300" y="496"]

; 未読スキップ-ON
[button name="unread_on"  fix="true" target="*skip_on"  graphic="&tf.btn_path_off" enterimg="&tf.btn_path_on_h" width="56" height="56" x="444" y="496"]

;-------------------------------------------------------------------------------
; 画面サイズ
;-------------------------------------------------------------------------------
; フルスクリーン
[button name="screen_full" fix="true" target="*screen_full" graphic="&tf.btn_path_off" enterimg="&tf.btn_path_on_h" width="56" height="56" x="804" y="496"]

; ウィンドウサイズ
[button name="screen_window" fix="true" target="*screen_window" graphic="&tf.btn_path_off" enterimg="&tf.btn_path_on_h" width="56" height="56" x="948" y="496"]
...
[image layer="0" name="unread_on" storage="../others/plugin/theme_kopanda_19/image/config/set.png" x="444" y="496"]
...
[image layer="0" name="unread_off" storage="../others/plugin/theme_kopanda_19/image/config/set.png" x="300" y="496"]
...
[if exp="tf.screen_size == 'full'"]
	...
	[image layer="0" name="screen_window" storage="../others/plugin/theme_kopanda_19/image/config/set.png" x="948" y="496"]
...
[if exp="tf.screen_size == 'window'"]
	...
	[image layer="0" name="screen_full" storage="../others/plugin/theme_kopanda_19/image/config/set.png" x="804" y="496"]
...
[if exp="tf.config_num_bgm == 0"]
	[image layer="0" name="bgmvol" storage="&tf.img_path + 'mute.png'" x="&tf.config_x[0]" y="184"]
[else]
